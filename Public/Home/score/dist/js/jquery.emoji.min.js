    ...
    Plugin.prototype = {
        _init: function () {
            ...
            if (!btn) {
                ...
                contentTop = this.$content.outerHeight() - 47;
                contentLeft = this.$content.outerHeight() - 38;
                $(newBtn).appendTo($('.chatPost'));
            ...
            $(emoji_container).appendTo($('.chatPost'));

            btnTop =  $(btn).outerHeight() - 397;
            btnLeft = $(btn).outerHeight() - 5;
            $('#emoji_container_' + ix).css({'top': btnTop + 'px', 'left': '-1px'});
                    ...
                    if (target === $(btn)[0]) {
                        ...
                        if (code) {
                            if (field.nodeName === 'DIV') {
                                ...
                                insertHtml = '<img class="emoji_icon" src="' + imgSrc + '" title="'+code+'">';
