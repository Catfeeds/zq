...
function getGameList(){
    ...
    $.ajax({
            ...
            if(data.status == 1){
                ...
                $.each(game,function(k,v){
                    ...
                    if(v[40] == 1 || v[41] == 1){
                        ...
                        var videoStr = '<a href="javascript:;"><img src="'+staticDomain+'/Public/Home/score/images/scoreLive/'+videoImg+'" width="24" height="24"></a>';
                    }else{
                        var videoStr = '';
                    }
                    //角球
                    ...
                    var gambleStr = v[44] == 1 ? '<a href="javascript:;" class="text-bblue">推荐</a>' : '';
                    var newsStr = v[48] == 1 ? '<a href="javascript:;" class="text-bblue">情报</a>' : '';
                    if(v[49] != '' || v[50] != ''){
                    ...
                    var tr =
                            ...
                            '</td>'+
                            '<td class="match-name no-b-r no-b-l" union_color="'+v[5]+'"><a href="javascript:;" style="background: '+v[5]+'"><span class="changeLang" langName="'+v[2]+','+v[3]+','+v[4]+'">'+v[2]+'</span></a></td>'+
                            '<td class="no-b-r no-b-l">'+v[9]+'</td>'+
                            '<td game_state="'+v[7]+'" class="gameStatusStr text-999 no-b-r no-b-l">'+timeStr+'</td>'+
                            '<td class="gameHomeName no-b-r" style="text-align: right;"><a href="javascript:;">'+homeRedStr+homeYellowStr+'<span>'+homeRankStr+'<span class="changeLang" langName="'+v[13]+','+v[14]+','+v[15]+'">'+v[13]+'</span></span></a></td>'+
                            '<td class="show_score gameScoreSign no-b-r no-b-l" first="'+v[34]+'">'+
                            '<a class="text-blue strong" href="javascript:;">'+scoreStr+'</a>'+
                            '</td>'+
                            '<td class="gameAwayName no-b-l no-b-r" style="text-align: left;"><a href="javascript:;"><span><span class="changeLang" langName="'+v[16]+','+v[17]+','+v[18]+'">'+v[16]+'</span>'+awayRankStr+'</span>'+awayYellowStr+awayRedStr+'</a></td>'+
        ...
        complete: function(XMLHttpRequest, textStatus) {
            ...
            // var data = '{"status": 1, "data": {"1567966": ["1567966", "3", "1", "1", "2", "2", "1", "2", "2", "3", "", "20180614183800", "5", "8","测试1","测试2"]}, "msg": ""}';
            // gameChange(data);
            //赛事隐藏统计
            hideCount();
        }
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var html = '<div class="livetab" game_id="' + game_id + '" style="width: 550px; visibility: visible;">' +
                ...
                '<tbody>' +
                '<tr>' +
                '<td class="event" width="20%" style="border-top: none;' + union_color + '"><a href="#" style="color:#FFF">' + union_name + '</a></td>' +
