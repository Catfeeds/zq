        ...
        build: function() {
            ...
            var g = (function(A) {
                ...
                u = A.length; v < u; v++) {
                    ...
                    w.push('<li scroll-type="item" class="' + z + '" action-type="select" action-data="index=' + v + '" ' + y + '><a hidefocus href="javascript:;" title="' + x.title + '"><img src="' + x.img_100_100 + '" alt="' + x.title + '" alt="' + x.title + '"/></a></li>')
                }
                return w.join("")
            })(o);
