...
$(function(){
	$(".p1_logo,.p1_img01,.p1_img02,.p1_img03,.p1_img04").addClass('animate');
	...
	$.fn.fullpage({
		...
		'afterLoad': function(anchorLink, index){
			if(index == 1){
				...
				$(".p1_logo,.p1_img01,.p1_img02,.p1_img03,.p1_img04").removeClass('animate');
			}
			if(index == 2){
	...
	// 	var i = $(this).index();
	// 	$(this).removeClass('animate').stop().animate({'opacity':'0.6'},200);
	// },function(){
	// 	$(this).css({'opacity':'1'});
	// })
})
