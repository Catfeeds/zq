            ...
            $.ajax({
                ...
                beforeSend:function(){
                    var load = '<div class="text-999 loadp" style="text-align: center;padding-top: 50px;">'+
                                    '<span><img src="'+staticDomain+'/Public/Mobile/images/load.gif"></span>'+
                    ...
                    switch(code){
                        ...
                        case 2:
                            var html = '<div class="uState">'+
                                            '<div class="uImg text-center"><img src="'+staticDomain+'/Public/Home/images/index/uImg.png"></div>'+
                        ...
                        case 3:
                            var html = '<div class="uState">'+
                                            '<div class="uImg text-center"><img src="'+staticDomain+'/Public/Home/images/index/pImg.png" alt=""></div>'+
