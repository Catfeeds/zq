        ...
        success: function (data) {
            if (data.status == 1)
            {
                var $modalHtml = '<div class="modal-scrollable" style="z-index: 1050;">' +
                    ' <div class="modal fade bs-example-modal-sm in" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="false" style="display: block; margin-top: -99.5px;top: 45%;margin-left: 40%;width: 400px;">' +
            ...
            else
            {
                ...
                if (data.errorCode == 8009)
                {
                    var $modalHtml = '<div class="modal-scrollable" style="z-index: 1050;">' +
                        ...
                        ' <dd>您的余额不足，请充值！</dd></dl>' +
                        ' <div class="btn-con" style="text-align: center; margin-top: 15px;">' +
                        ' <button style="width: 100px; border-radius: 3px;" type="button" class="btn btn-orange"  onclick="window.open(\'//www.' + DOMAIN + '/UserInfo/charge.html\')">马上去' +
                        ' </button>' +
                            ...
                            case 1111:
                                ...
                                if(list != null)
                                {
                                    $.each(list,function (key,value) {
                                        ...
                                        {
                                            resulthtml = '<img src="'+staticDomain+'/Public/Home/images/qw/win.png" alt="">';
                                        }
                                        if (value['result'] == '-1' || value['result'] == '-0.5')
                                        {
                                            resulthtml = '<img src="'+staticDomain+'/Public/Home/images/qw/lose.png" alt="">';
                                        }
                                        if (value['result'].indexOf("-10,-11,-12,-13,-14") != '-1')
                                        {
                                            resulthtml = '<img src="'+staticDomain+'/Public/Home/images/qw/zou.png" alt="">';
                                        }
                                ...
                                {
                                    gameHtml = ' <tr> <td colspan = "6" class="wait"><img src="'+staticDomain+'/Public/Home/images/qw/wait.png" alt="">敬请期待 </td> </tr>';
                                }
