...
a=b(this).closest(".section").find(".slides");var c=a.find(".slide").eq(b(this).closest("li").index());u(a,c)})}})(jQuery);/*! jQuery UI - v1.10.3 - 2013-05-03
* http://jqueryui.com
...
$(function(){
	$(".p1_logo,.p1_img01,.p1_img02,.p1_img03,.p1_btn01,.p1_btn02,.p1_btn03,.p1_phone").addClass('animate');
	...
	function myParallax(){
		...
		/*wrap.mousemove(function(event){
			...
			y6 = (y/10*0.2)+473; 
			ele01.css({"left":x1});
			ele011.css({"right":x11});
			ele012.css({"left":x12});
			ele02.css({"left":x2,"top":y2});
			ele03.css({"left":x3,"top":y3});
			ele04.css({"left":x4,"top":y4});
			ele05.css({"left":x5,"top":y5});
			ele06.css({"right":x6,"top":y6});
		})*/
	}
	...
	$.fn.fullpage({
		...
		'afterLoad': function(anchorLink, index){
			if(index == 1){
				...
				$(".p1_logo,.p1_img01,.p1_img02,.p1_img03,.p1_btn01,.p1_btn02,.p1_btn03,.p1_phone").removeClass('animate');
			}
			if(index == 2){
				$(".p2_img01,.p2_img02,.p2_img03,.p2_img04,.p2_img05").addClass('animate');
			}else{
				$(".p2_img01,.p2_img02,.p2_img03,.p2_img04,.p2_img05").removeClass('animate');
			}
			if(index == 3){
				$(".p4_img01,.p4_img02,.p4_img03,.p4_text01,.p4_text02,.p4_text03,.p4_text04,.p4_text05,.p4_text06,.p4_text07,.p4_text08,.p4_text09,.p4_text10,.pro1,.pro2,.pro3,.pro4").addClass('animate');
			}else{
				$(".p4_img01,.p4_img02,.p4_img03,.p4_text01,.p4_text02,.p4_text03,.p4_text04,.p4_text05,.p4_text06,.p4_text07,.p4_text08,.p4_text09,.p4_text10,.pro1,.pro2,.pro3,.pro4").removeClass('animate');
				
			}
			if(index == 4){
				$(".p3_img01,.p3_img02,.p3_img03,.p3_img04,.p3_img05,.p3_img06,.animateWrap").addClass('animate');
			}else{
				$(".p3_img01,.p3_img02,.p3_img03,.p3_img04,.p3_img05,.p3_img06,.animateWrap").removeClass('animate');
			}
			if(index == 5){
				$(".p5_img01,.p5_img02,.p5_img03,.p5_img04,.p5_img05,.p5_img06,.p5_img07").addClass('animate');
			}else{
				$(".p5_img01,.p5_img02,.p5_img03,.p5_img04,.p5_img05,.p5_img06,.p5_img07").removeClass('animate');
			}
	...
	//p1_tab
	$(".p1_tabBtn a").hover(function(){
		var i = $(this).index();
		$(".p1_tabCon ul li").eq(i).addClass("active");
	},function(){
		$(".p1_tabCon ul li").removeClass("active");
	})
	//p5_tab
	$(".p5_tabBtn a").hover(function(){
		var i = $(this).index();
		$(".p5_tabCon ul li").eq(i).addClass("active");
	},function(){
		$(".p5_tabCon ul li").removeClass("active");
	})
})
