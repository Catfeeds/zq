...
function showState(){ 
   ...
   if (localStorage.getItem("rankShow") == 1){
    ...
    //页面刷新间隔
    var reTime = document.getElementById("refreshTime");
    if(localStorage.getItem("refreshTime") == "5"){
       reTime.selectedIndex = 0;
    }else if(localStorage.getItem("refreshTime") == "8"){
       reTime.selectedIndex = 1;
    }else if(localStorage.getItem("refreshTime") == "10"){
       reTime.selectedIndex = 2;
    }else if(localStorage.getItem("refreshTime") == "15"){
       reTime.selectedIndex = 3;
    }else if(localStorage.getItem("refreshTime") == "20"){
       reTime.selectedIndex = 4;
    }else if(localStorage.getItem("refreshTime") == "50"){
       reTime.selectedIndex = 5;
    }else{
       reTime.selectedIndex = 0;
    }
