$(function () {
    ...
    if (localStorage.getItem("yellowShow") == '1') {
        $(".yel_card,.red_card").removeClass("hidden");
    }
    ...
    if (localStorage.getItem("yellowShow") == 0) {
        $(".yel_card,.red_card").hide();
    }
    ...
    setInterval(function () {
        ...
        {
            Cookie.delCookie('M_Now');
            Cookie.delCookie('Schedule');
            Cookie.delCookie('ScheRes');
            Cookie.delCookie('M_OddsType');
            Cookie.delCookie('M_Event');
...
function scoreTan(time)
{
    ...
    $.ajax({
        type: 'post',
        url: '/Sporttery/ScoreInstant.html',
        dataType: 'json',
                ...
                $.each(data.info, function (i, val) {
                    ...
                    if (val[1] != oldStatus) {
                        ...
                        if (val[1] < 0)
                        {
                            ...
                            $this.find('.js-data').attr('data-url', '/Details/event_technology/scheid/'+ val[0]);
