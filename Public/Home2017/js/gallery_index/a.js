...
// SLIDE screen
(function() {
	var LI_WIDTH = [583, 199, 199, 198, 198], 
		LI_DOM = [$('.slide_screen li.liA'), $('.slide_screen li.liB'), $('.slide_screen li.liC'), $('.slide_screen li.liD'), $('.slide_screen li.liE')], 
		LI_BTN = $('.slide_screen .libtn'),
		COUNT =  2, SPEED = 1000, DISTIM = 6000, LI_COUNT = 5;
