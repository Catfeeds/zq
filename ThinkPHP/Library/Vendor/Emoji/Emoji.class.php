<?php
	...
	function emoji_unified_to_html($text){
		return preg_replace_callback($GLOBALS['emoji_maps']['unified_rx'], function($m){
			...
			return "<span class=\"emoji emoji{$cp}\" title=\"smiling face with open mouth and smiling eyes\"></span>";
		}, $text);
	}
    ...
    function emoji_html_to_unified2($text){
        return preg_replace_callback("!<img class=\"emoji_icon\" src=\"(.*?)\" title=\"([0-9a-f]+)\">!", function($m){
            if (isset($GLOBALS['emoji_maps']['html_to_unified'][$m[2]])){
                return $GLOBALS['emoji_maps']['html_to_unified'][$m[2]];
            }
            return $m[0];
        }, $text);
    }

    function emoji_html_to_unified3($m){
        return $GLOBALS['emoji_maps']['html_to_unified'][$m];
    }
