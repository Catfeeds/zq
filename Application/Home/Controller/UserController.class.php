...
class UserController extends CommonController {
    ...
    */
    ...
    {
		//验证type的数值
		if(preg_match('/^[a-zA-Z0-9]*$/', $type) == 0 || empty($type)) $this->error('参数错误');
    ...
    */
     ...
     * 判断该ip跟设备是否多次注册
     */
    public function RegVerification()
    {
        if(!D('FrontUser')->checkReg(I('deviceID'))) $this->error('该设备注册次数过多!');
    }
}