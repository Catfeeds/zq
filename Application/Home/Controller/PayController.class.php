...
class PayController extends CommonController
{
        ...
        switch (I('payType')) {
            case '1':
                ...
                if($rsl){
                    ...
                    echo "<script>alert('支付失败,请重试!');location.href='//www.qqty.com/UserInfo/charge.html'</script>";
                    die;
                }
            case '2':
     ...
     * 本地生成二维码
     */
    public function getLocaltionQrCode()
    {
	    vendor("WxQrcode.phpqrcode");
	    $url = urldecode($_GET["data_url"]);
	    $no = $_GET['data_no'];
	    if(substr($url, 0, 6) == "weixin") {
		    QRcode::png($url, $no.".png", 'QR_ECLEVEL_L', 6, 4);
		    $image_data_base64 = "data:image/png;base64,". base64_encode (file_get_contents($no.".png"));
		    unlink($no.".png");
