...
class EasemobController extends PublicController
{
    ...
    */
    ...
    public function sendText()
    {
        ...
        //1：资讯  2：图集  9：外链
        $ext = [
            'em_apns_ext' => ['em_push_title'=>'testing','em_module'=>['module'=>9,'url'=>'http://jd.com']]
        ];

        $info = $Easemob->sendText($from="admin",$target_type='users',$target=[$this->param['username']],'testing a msg',$ext);
        $this->ajaxReturn(['info'=>$info]);
    }
}
