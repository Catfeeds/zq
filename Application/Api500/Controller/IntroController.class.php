...
class IntroController extends PublicController
{
    ...
    public function index()
    {
        ...
        $products = M('IntroProducts')->alias('P')
            ->field('P.id,P.class_id,P.name,P.`desc`,P.logo,P.sale,P.game_num,P.rate_num,P.total_rate,P.remark,C.background')
    ...
    public function categoryDetail(){
        ...
        $products = M('IntroProducts')
            ->field('id,class_id,name, `desc`,logo,sale,game_num,rate_num,total_rate,remark')
    ...
    public function productDetail(){
        ...
        $products = M('introProducts')->field('id,name,desc,logo,logo,sale,total_num,pay_num,game_num,rate_num,total_rate,create_time')->where(['id' => $productId])->find();
        if($page <= 1 ){
            if(!$products)
