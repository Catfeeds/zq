...
class UserController extends CommonController
{
    ...
    public function index()
    {
        ...
        $userInfo = M('FrontUser')
                ->field(['nick_name','username','vip_time','area_code','lv','lv_bet','lv_bk','head face','point','coin','unable_coin','descript','weixin_unionid','sina_unionid','qq_unionid','mm_unionid','is_expert','expert_status','reason','customer_msg as customerNum'])
                ->where(['id'=>$user_id])
                ->find();
