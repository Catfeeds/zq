...
class UserController extends CommonController
{
    ...
    public function myFollowUser()
    {
        ...
        $list = M('FollowUser f')->field('f.follow_id user_id,u.nick_name,u.lv,f.sub, u.head face,u.descript')
    ...
    public function myFans()
    {
        ...
        foreach ($list as $k => $v)
        {
            ...
            $list[$k]['isFollow']   =  $res ? '1' : '0'; //是否已经关注
            $list[$k]['sub']        =  $res ? $res['sub'] : '0'; //是否已经订阅
        }
