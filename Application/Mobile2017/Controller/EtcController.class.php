...
class EtcController extends CommonController {
    ...
    public function index() {
        ...
        $hot_list = $_Publish->alias('pl')->field('pl.id,img,short_title,remark')
...
//            6 => 3000,
    ...
    {
        $prize_arr = array(
          '0' => array('id'=>'1','prize'=>'iphone6S(128G)','v'=>0 , 'img'=>"/Public/Mobile/images/etc/jp01.png"          ),
          '1' => array('id'=>'2','prize'=>'恒大7月VIP门票','v'=>0 , 'img'=>"/Public/Mobile/images/etc/img_cj_myq.png"    ),
          '2' => array('id'=>'3','prize'=>'4G流量卡',      'v'=>2,  'img'=>"/Public/Mobile/images/etc/img_cj_myq_50.png" ),
          '3' => array('id'=>'4','prize'=>'行车记录仪',    'v'=>0,  'img'=>"/Public/Mobile/images/etc/img_cj_xxcy.png"   ),
          '4' => array('id'=>'5','prize'=>'2000积分',      'v'=>15, 'img'=>"/Public/Mobile/images/etc/img_cj_jinbi.png"  ),
          '5' => array('id'=>'6','prize'=>'4G流量卡',      'v'=>4,  'img'=>"/Public/Mobile/images/etc/img_cj_myq_100.png"),
          '6' => array('id'=>'7','prize'=>'1000积分',      'v'=>79, 'img'=>"/Public/Mobile/images/etc/img_cj_jinbi.png"  ),
          '7' => array('id'=>'8','prize'=>'欧洲杯官方T恤', 'v'=>0,  'img'=>"/Public/Mobile/images/etc/img_cj_smdl.png"   ),
        );
        return $prize_arr;
    }
