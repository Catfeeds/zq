...
class BaseModel extends Model
{
     ...
     * @param int $gameType 1：足球亚盘 2：篮球亚盘 3:足球竞猜 4:篮球竞猜
    ...
    public function getDelicateList($dateType = 1,$gameType = 1,$num = 50,$resultNum = 12)
    {
		...
		{
			case 1:
				$field = ',f.fb_ten_gamble as tenGambleRate';
				$gameType = 1;
				break;
			case 2:
				$field = ',f.bk_ten_gamble as tenGambleRate';
				$gameType = 2;
				break;
			case 3:
				$field = ',f.fb_ten_bet as tenGambleRate';
				$gameType = 1;
				break;
			case 4:
				$field = ',f.bk_ten_bet as tenGambleRate';
				$gameType = 2;
				break;
		}
        ...
        $rankUserArr = M('RankingList r')
                    ...
                    ->field('r.user_id,r.winrate, f.nick_name, f.head,f.lv,f.lv_bet'.$field)
                    ->where(['dateType' => $dateType,
                             'gameType' => $gameType,
                             'ranking'=>['elt',$num],
                             'begin_date'=>['between',[$rankDate[0],$rankDate[1]]]])
					->order('tenGambleRate desc')
                    ->select();
    ...
    public function getWinnigList($dateType = 1,$gameType = 1,$num = 50,$resultNum = 12)
    {
        ...
        $rankUserArr = D('Common')->getRankingData($gameType,$dateType,null,50);
        ...
        //根据连胜场数排序
        array_multisort(array_column($rankUserArr,'curr_victs'),SORT_DESC,$rankUserArr);
    ...
    public function getWinnigRaceList($dateType = 1,$gameType = 1,$num = 50,$resultNum = 12)
    {
        ...
        //根据连胜场数排序
        array_multisort(array_column($rankBettingArr,'curr_victs'),SORT_DESC,$rankBettingArr);
