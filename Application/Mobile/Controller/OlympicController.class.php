...
class OlympicController extends CommonController {
        ...
        if ($user_auth) {
            ...
            if (IS_AJAX) {
                ...
                foreach ($record as $k => $v) {
                    ...
                    $li .= "<div class=\"n_top\">" .
                            "<aside><img src=\"".staticDomain('/Public/Mobile/images/Olympic/gr_title.png')."\"><span>" . $v['union_name'] . "</span> <time>" . date('m-d H:i', $v['game_time']) . "</time></aside>" .
                            "</div>" .
    ...
    public function rank_list() {
        ...
        foreach ($rank as $k => $v) {
            ...
            if($rank[$k]['head']==NULL){
                $rank[$k]['head']=staticDomain('/Public/Mobile/images/default_head.png');
            }
        }
