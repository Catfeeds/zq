...
class AppdataController extends AppverifyController
// class AppdataController extends Controller
{
    ...
    public function chodds()
    {
        ...
        $fbService = new \Home\Services\AppfbService();
        $res = $fbService->getChoddsB($unionId,$subId);
    ...
    public function analysis()
    {
        ...
        $appService = new \Home\Services\AppdataService();
        $res = $appService->getAnalysis($gameId,$key);
    ...
    public function country()
    {
        ...
        $appService = new \Home\Services\AppdataService();
        $res = $appService->getCountry($continentId ,$lang);
    ...
    */
    ...
    public function bkodds()
    {
        $gameId = !empty($_REQUEST['gameId'])? $_REQUEST['gameId'] : null;
        $appService = new \Home\Services\AppdatabkService();
        $res = $appService->getbkodds($gameId);
        if($res === false)
        {
            $data['status']  = 0;
            $data['data'] = null;
    ...
    */
    ...
    public function test()
    {
        ...
        $res1 = $fbService->getSkilldata(26363,1471959000);
