...
class CrawlerController extends CommonController
{
    ...
    public function sitemap(){
        ...
        $news = M('PublishList')->field("id,add_time")->where(['status'=>1,'is_original'=>1,'add_time'=>['gt',$add_time]])->order('add_time desc')->select();
        // echo M('PublishList')->_sql();
        // dump($news);
        // die;
        ...
        $sitemap .= "<url>\r\n".
                    ...
                    "</url>\r\n";
        $sitemap .= "<url>\r\n".
                        "<loc>https://www.qqty.com/Api/Index/introduce.html</loc>\r\n".
                        "<priority>1.0</priority>\r\n".
                        "<lastmod>".date('Y-m-d',time())."</lastmod>\r\n".
        ...
        $sitemap .= "<url>\r\n".
                    ...
                    "</url>\r\n";
        $sitemap .= "<url>\r\n".
                        "<loc>https://www.qqty.com/analysts.html</loc>\r\n".
                        "<priority>1.0</priority>\r\n".
                        "<lastmod>".date('Y-m-d',time())."</lastmod>\r\n".
                        "<changefreq>always</changefreq>\r\n".
                    "</url>\r\n";
        ...
        {
            $sitemap .= "<url>\r\n".
                            "<loc>".'https://www.qqty.com/news/'.$v['id'].".html</loc>\r\n".
