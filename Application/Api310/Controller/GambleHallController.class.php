...
*/
    ...
    public function user()
    {
        ...
        if($page == 1){
            ...
            $tenGamble               = $gamble['tenGambleRate'];
    ...
    public function hotMaster()
    {
        ...
        $cacheKey = MODULE_NAME . 'hotMaster_' . $platform;
        if(!$list = S($cacheKey)){
            $userToken = getUserToken($this->param['userToken']);
            ...
            foreach($ypMaster as $k1=>$vl){
                ...
                $ypList[$k1]['tenGambleRate']  = (string)($platform == 3 ?$vl['tenGambleRate'] * 10 : $vl['tenGambleRate']);
            }
            ...
            foreach($jcMaster as $k2=>$v2){
                ...
                $jcList[$k2]['tenGambleRate']  = (string)($platform == 3 ?$v2['tenGambleRate'] * 10 : $v2['tenGambleRate']);
            }
