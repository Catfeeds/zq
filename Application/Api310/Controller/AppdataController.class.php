...
class AppdataController extends Controller
{
    ...
    public function _initialize()
    {
        ...
        if($this->param['nosign'] != C('nosignStr') && ACTION_NAME != 'animate' && ACTION_NAME != 'aniOver'&& ACTION_NAME != 'analysis' && ACTION_NAME != 'aniOverTest')
        {
    ...
    public function aniOverTest()
    {
        ...
        $appService = new \Home\Services\AppfbService();
        $res = $appService->getFlashOverTest($gameId,$uptime);
        if($res === false)
        {
            $data['status']  = 0;
            $data['data'] = [];
