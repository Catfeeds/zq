...
class UserController extends CommonController
{
    ...
    public function index()
    {
        $userInfo = M('FrontUser')
                ->field(['nick_name','lv','lv_bet','head face','point','coin','unable_coin','descript','weixin_unionid','sina_unionid','qq_unionid','mm_unionid'])
    ...
    public function myFollowGamble()
    {
        ...
        if ($follows) {
            ...
            foreach ($gambleList as $k => $v) {
                ...
                //是否已经购买查看过
                $userInfo['is_trade'] = D('Common')->getTradeLog($v['gamble_id'], $this->userInfo['userid']);
